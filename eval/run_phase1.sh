...
echo "=== Deep-Research Phase 1: $(date) ==="
...
run_model 4 "LiquidAI/LFM2-2.6B" &
PIDS+=($!); LABELS+=("GPU4 LFM2-2.6B")
run_model 5 "Qwen/Qwen3.5-27B" &
PIDS+=($!); LABELS+=("GPU5 Qwen3.5-27B")
run_model 6 "Qwen/Qwen3.5-35B-A3B" &
PIDS+=($!); LABELS+=("GPU6 Qwen3.5-35B-A3B")
run_model 7 "LiquidAI/LFM2-8B-A1B" &
PIDS+=($!); LABELS+=("GPU7 LFM2-8B-A1B")
